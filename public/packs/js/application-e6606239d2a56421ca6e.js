...
__webpack_require__(/*! reviews */ "./app/javascript/reviews.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
for (i = 0; i < stars.length; i++) {
  stars[i].addEventListener("mouseover", function () {
    ...
    for (var _j = 0; i <= i; _j++) {
      stars[_j].classList.remove("fa-star-o");
...
/******/ });
//# sourceMappingURL=application-e6606239d2a56421ca6e.js.map